...
function ManageUser(){
		...
		if (paket.err===0){
			for (var x in paket.data) {
				...
				html+='<td><b>'+paket.data[x].invite_resp+'</b></td>'
					...
					+'<td><button type="button" id="btn_delete" onclick="objModul.deleteData(\''+paket.data[x].invite_blok+'\');">Delete</button></td>'
					+'</tr>';
			}
		}
	...
	function createData(){
		...
		html='<button type="button" id="btn_back" onclick="objModul.readData();">Back</button>'
			+'<button type="button" id="btn_send" onclick="objModul.createExecute();">Send</button>'
	...
	function deleteData(blok_id){
		...
		msg.innerHTML='';
		html='<button type="button" id="btn_back" onclick="objModul.readData();">Back</button>'
			+'<button type="button" id="btn_continue" onclick="objModul.deleteExecute(\''+blok_id+'\');">Delete</button>';
		btn.innerHTML=html;
	...
	function accessData(blok_id){
		...
		metode.innerHTML='Read Data';
		html='<button type="button" id="btn_back" onclick="objModul.readData();">Back</button>'
			+'<button type="button" id="btn_save" onclick="objModul.accessCreateData(\''+blok_id+'\');">Save</button>';
		btn.innerHTML=html;	
