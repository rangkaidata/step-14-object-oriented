...
function UserProfile(){
	...
	function readData(){
		...
		msg.innerHTML='';
		btn.innerHTML='<button type="button" onclick="objModul.updateData()">Change</button>';
	...
	function updateData(){
		...
		html='<button type="button" onclick="objModul.readData()">Back</button>'
			+'<button type="button" id="btn_save" onclick="objModul.updateExecute()">Update</button>';
		btn.innerHTML=html;
	}
